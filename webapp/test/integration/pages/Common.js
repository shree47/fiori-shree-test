sap.ui.define([
	...
	return Opa5.extend("com.mycompany.northwind.fiori-shree-test.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/mycompany/northwind/fiori-shree-test/localService/mockserver"], function (mockserver) {
